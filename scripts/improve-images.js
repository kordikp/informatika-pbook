...
const SYSTEM = `You improve SVG illustrations for the living Czech textbook "Jak funguje digitální svět" (computer science for 8th grade). All labels are in CZECH and must stay in correct Czech. You receive an existing SVG plus a QA note, and return an improved SVG.
