# Jak funguje živá kniha

Tahle učebnice není hotový text, který někdo napsal a zamkl. Je to **živá kniha**: roste podle toho, co čtenáře zajímá, a přispět do ní může každý — i ty. Tady je celý mechanismus na jednom místě.

## Tři vrstvy obsahu

| Označení | Co to je | Kdo to vidí |
|---|---|---|
| **CORE** (bez odznaku) | Redakčně ověřené jádro knihy — 63 konceptů z Mapy informatických konceptů | všichni |
| ⚡ **vygenerováno na tvoje přání** | Podání, která sis nechal napsat nebo upravit ty | jen ty (dokud je nesdílíš) |
| 🌱 **sdílel čtenář · zatím bez redakce** | Příspěvky ostatních čtenářů | všichni v Otevřeném režimu |

Ověřené jádro se tvými experimenty nikdy nerozbije — originál každé sekce zůstává vždy na svém místě a jde se k němu jedním klikem vrátit.
...
Redakce se nejmenuje, **vyslouží se** — kniha to počítá automaticky (Profil → 🛠 Redakční dráha):

- **1 převzaté podání** do core knihy, **nebo**
- **5 sdílených podání + 5 nahlášených chyb.**

Redaktoři pak vidí u komunitních příspěvků tlačítko 📥 Převzít a spravují, co se dostane do ověřeného jádra.

## Poctivost a soukromí

- **AI se přiznává.** Všechno, co vytvořila AI, je viditelně označené (⚡). Stejnou poctivost uč kniha i tebe — je to jedno z jejích témat.
- **Tvoje čtení zůstává u tebe.** Postup, poznámky, kartičky i drafty žijí ve tvém prohlížeči (Nastavení → Stáhnout všechna data / Smazat vše).
- **Veřejné je jen to, co sám sdílíš** — a hlasování o zájmu, které se sčítá anonymně.
- **Kontrakty hlídají kvalitu.** AI negeneruje volně: každý koncept má lidmi sepsané zadání (co pokrýt, co je zakázáno — žádná vymyšlená čísla a citace) a výstup se proti němu kontroluje. Ověřuj ale i tak — přesně jak tě kniha učí.
